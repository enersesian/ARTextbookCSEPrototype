...
namespace GoogleARCore.Examples.AugmentedImage
{
    ...
    /// </remarks>
    public class ARBookPageController : MonoBehaviour
    {
        /// <summary>
        /// A prefab for visualizing an AugmentedImage.
        /// </summary>
        public ARBookPageVisualizer ARBookPageVisualizerPrefab;
        ...
        private Dictionary<int, ARBookPageVisualizer> m_Visualizers
            = new Dictionary<int, ARBookPageVisualizer>();
        ...
        public void Update()
        {
            ...
            {
                ARBookPageVisualizer visualizer = null;
                m_Visualizers.TryGetValue(image.DatabaseIndex, out visualizer);
                if (image.TrackingState == TrackingState.Tracking && visualizer == null)
                {
                    // Create an anchor to ensure that ARCore keeps tracking this augmented image.
                    Anchor anchor = image.CreateAnchor(image.CenterPose);
                    visualizer = (ARBookPageVisualizer)Instantiate(
